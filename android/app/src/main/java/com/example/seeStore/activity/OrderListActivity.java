...
import com.example.seeStore.adapter.OrderListAdapter;
import com.example.seeStore.customwidget.MySnackbar;
import com.example.seeStore.model.Order;
    ...
    private void handleResponse(JSONObject response) {
        try {
            ...
            for (int i = 0; i < orders.length(); i++) {
                ...
                System.out.println("odderlll111: " + order + json);
                Order order2 = Order.parseBasicJSON(json);
                if (order != null) {  // add this null check
                    allOrders.add(order);
                }
                System.out.println("odderlll222: " + allOrders);
